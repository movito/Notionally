...
// @version      1.16.0
// @description  v1.16.0 - Added Pulse article cover image extraction
...
(function() {
    ...
    */
    ...
    function extractPulseArticleData() {
        ...
        // Get author - MUST be a string for the server
        const authorElement = document.querySelector('.reader-author-info__name, .author-name, [data-test-id*="author-name"]');
        articleData.author = authorElement?.textContent.trim() || 'Unknown Author';
