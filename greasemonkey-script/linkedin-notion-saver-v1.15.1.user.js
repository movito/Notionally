...
// @version      1.15.1
// @description  v1.15.1 - Refined Pulse text extraction with max 2 newlines
...
(function() {
    ...
    */
    ...
    function extractPulseArticleData() {
        ...
        // Get images
        const images = Array.from(document.querySelectorAll('.reader-article-content img, article img'))
